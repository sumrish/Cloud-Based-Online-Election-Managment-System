...
<table id="t01">
	...
	<c:forEach items="${NatCandidatesList}" var="cand">
		<tr>   
			...
			<td><img src="/FinalFYP/myImage/NationalSymbolDisplay?ccnic=${cand.ccnic}" style="width:150px;height:100px;"/></td>
			<td>${cand.cid}</td>
			<td><img src="/FinalFYP/myImage/NationalImageDisplay?ccnic=${cand.ccnic}" style="width:150px;height:100px;"/></td>
