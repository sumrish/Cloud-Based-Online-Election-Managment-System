...
<table id="t01">
	...
	<c:forEach items="${ProSearch}" var="candidate">
		<tr>   
			...
			<td><img src="/FinalFYP/myImage/ProvisionalSymbolDisplay?ccnic=${candidate.ccnic}" style="width:304px;height:200px;"/></td>
			<td>${candidate.cid}</td>
			<td><img src="/FinalFYP/myImage/ProvisionalImageDisplay?ccnic=${candidate.ccnic}" style="width:304px;height:200px;"/></td>
